...
//repo
  container.bind(TYPES.IRedisRepo).toConstantValue(new RedisRepository(getRedisClient));
  ...
  container.bind<IOtpService>(TYPES.IOtpService).to(OtpService).inSingletonScope();
